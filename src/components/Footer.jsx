    ...
    <footer>
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-[14px] text-left">
          <div>
            {/*Titre */}
            <h3 className="font-semibold text-[#3B82F6] text-[12px]">LaundryMap</h3>
            {/* Liens rapides */}
            <div>
              <ul className="text-left space-y-2">
                <li>
                  <a href="#" className="text-[#64748B] text-[12px] font-medium hover:text-[#3B82F6] transition duration-300">
                    À propos
                  </a>
                </li>
                <li>
          ...
          {/* Contact */}
          <div>
            <h3 className="font-semibold text-[#3B82F6] text-[12px]">Contact</h3>
            <ul className="space-y-2 text-gray-300">
              ...
              <li>
                <a href='#' className="text-[#64748B] text-[12px] font-medium flex items-center">
        ...
        <div className="flex justify-center gap-[14px] space-x-4 mt-4">
          <a href="#" className="hover:text-[#3B82F6] transition duration-300">
      ...
      <div className="container mx-auto px-4">
        <div className="py-6 text-center">
          <p className="text-[#64748B] text-[10px] font-regular text-[12px] mb-4">
          ...
          <div className="flex sm:flex-row justify-center items-center gap-2 sm:gap-6 mb-4">
            <a href="#" className="text-[#64748B] text-[10px] font-regular hover:text-[#3B82F6] transition duration-300">
              Mentions légales
            </a>
            <a href="#" className="text-[#64748B] text-[10px] font-regular hover:text-[#3B82F6] transition duration-300">
              CGU
