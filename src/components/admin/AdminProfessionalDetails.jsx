...
const AdminProfessionalDetails = ({ isDarkTheme }) => {
  ...
  const businessIdentifierLabel =
    normalizedBusinessIdentifier.length === 9 ? 'SIREN' : 'SIRET';
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3">
        {/* Colonne principale - Informations */}
            ...
            <div className='flex flex-col'>
              ...
              <h2 className="text-[13px] text-left font-medium text-[#111827]">
                <img src={AdministratorIcon} alt="Admin Icon" className="inline-block w-4 h-4 mr-1" />
                {t('admin.professional_profile')}
              </h2>
              <div className="mt-4 rounded-lg border-l-2 border-l-[#F59E0B] px-4 py-3">
              ...
              {!isApproved && !isRejected && showRejectModal && (
                <div className="mb-6 p-4 flex flex-col gap-[15px] rounded-lg ">
                  <div className='flex flex-col gap-[4px]'>
                    ...
                    <p className='font-regular text-[12px] text-[#6B7280]'>Professionnel refusé, veuillez préciser la raison.</p>
                  </div>
                  <textarea
