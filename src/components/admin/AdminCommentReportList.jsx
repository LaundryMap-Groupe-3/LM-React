          ...
          <div className="space-y-3 mb-8">
            {items.map((item) => (
              <button
                ...
                className="w-full text-left rounded-lg shadow-md border-l-4 border-[#EF4444] overflow-hidden bg-white hover:shadow-lg transition-shadow duration-300 p-4 flex items-center gap-4"
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2 mb-1 flex-wrap">
                    <span className="text-[12px] px-2 py-0.5 rounded-full bg-[#EF4444]/10 text-[#EF4444] font-semibold whitespace-nowrap">
                    ...
                    {item.author && (
                      <span className="text-[13px] text-gray-500">
                        ...
                        <span className="font-medium text-[#111827]">{item.author.firstName} {item.author.lastName}</span>
                        {item.author.status === 'suspended' && (
                          <span className="ml-2 text-[11px] px-1.5 py-0.5 rounded-full bg-red-100 text-red-600 font-semibold">
